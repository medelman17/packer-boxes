/*
    DESCRIPTION:
    VMware Photon OS 5 variables using the Packer Builder for VMware vSphere (vsphere-iso).
*/
...
variable "vm_guest_os_name" {
  type        = string
  description = "The guest operating system name. Used for naming. (e.g. 'photon')"
}
